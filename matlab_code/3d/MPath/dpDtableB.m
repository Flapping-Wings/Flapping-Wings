...
function [ y ] = dpDtableB( t,rt,tau,p,rtOff )
...
% rtOff     rotation timing offset
    ...
    e3=exp(-2.0*p*(t*rt+tau-(3.0+rtOff))); %expand to accomodate phase shift tau=1   
    e4=exp(-2.0*p*(t*rt+tau-(4.0+rtOff))); %expand to accomodate phase shift tau=2 
