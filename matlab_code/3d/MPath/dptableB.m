...
function [ y ] = dptableB( t,rt,tau,p,rtOff )
...
% p         rotatio parameter
    ...
    f3=2.0./(1.0+exp(-2.0*p*(t*rt+tau-(3.0+rtOff)))); %expand to accomodate phase shift tau=1
    f4=2.0./(1.0+exp(-2.0*p*(t*rt+tau-(4.0+rtOff)))); %expand to accomodate phase shift tau=2
