function [] = dpsimpulseWT(istep,U,t,Xt,Xw,GAM,GAMAw,beta,phi,theta,a)
...
global limpa aimpa limpw aimpw %(j,nstep,w): initialized at the beginning
global nwing
...
for i=1:nwing
    ...
    limpw(:,istep,i)=limp; %limpw(i,:,istep)+limp;

    %Angulr impulse
    [ aimp ] =     aimpulse(Xw_T(:,:,:,i),n1,n2,GAMAw(i,:),beta(i),phi(i),theta(i),a(i));
    aimpw(:,istep,i)=aimp; %aimpw(:,istep)+aimp;
    end
end
end
